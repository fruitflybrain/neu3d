...
// Procedural "no purple" palette: only RGB triples where R or B is zero and
// at least one channel is > 127, stepped at 16. Used as the default colormap
// for neurons so synapses (colored via the rainbow_gist `synapseLut`) stand
// out against them. Ported from ffbo.lib develop @ 4ac0f7c.
...
Lut.prototype.addColorMap('noPurpleExpanded', getNoPurpleColor());
